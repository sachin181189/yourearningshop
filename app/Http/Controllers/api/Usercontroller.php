...
class Usercontroller extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        {
            $parent_referral_code = '8381818319';
        }
        else
        {
    ...
    public function getUserProfile(Request $request)
    {
        ...
        if(count($users) == 1)
        {
            ...
            //     {
            //          $uadata['id'] = $ua['id'];
            //          $uadata['fname'] = $ua['fname'];
            //          $uadata['phone'] = $ua['phone'];
            //          $uadata['flat'] = $ua['flat'];
            //          $uadata['area'] = $ua['area'];
            //          $uadata['landmark'] = $ua['landmark'];
            //          $uadata['city'] = $ua['city'];
            //          $uadata['state'] = $ua['state'];
            //          $uadata['zip'] = $ua['zip'];
            //          $uadata['is_default'] = $ua['is_default'];
            //     }
            // }
            // else
            // {
            ...
            foreach($users as $u)
            {
                 ...
                 $udata['referral_code'] = $u['referral_code'];
                 $udata['parent_referral_code'] = $u['parent_referral_code'];
                 $udata['status'] = $u['status'];
                if($u['image'] != '')
                {
                    $udata['image'] = url('/public/user_image').'/'.$u['image'];
                }else{
                    $udata['image'] = url('/public/user_image').'/default.png';
                }
                 $uadata['phone'] = $u['phone'];
                 $uadata['flat'] = $u['flat'];
                 $uadata['area'] = $u['area'];
                 $uadata['landmark'] = $u['landmark'];
                 $uadata['city'] = $u['city'];
                 $uadata['state'] = $u['state'];
                 $uadata['zip'] = $u['zip'];
