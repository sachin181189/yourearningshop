...
@else 
<script>window.location = "{{URL::to('admin/logout')}}"</script>
@endif
<?php 
                    ...
                    <center>
                        <a class="navbar-brand" href="#">
                            ...
                            <!-- <b class="logo-icon"> -->
                                ...
                                <!-- Dark Logo icon -->
                                <!-- <img src="{{asset('admin/images/logo-text.png')}}" alt="homepage" class="light-logo" /> -->
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" title="Notification" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="mdi mdi-bell font-24"></i>
                                <sup style="top: -1.5em!important;">{{count($notification)}}</sup>   
                            </a>
                             <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                             @foreach($notification as $notic)
                                <a class="dropdown-item" href="#" onclick="gotoUrl({{$notic->id}},'{{$notic->url}}');">{{$notic->notification}}</a>
                                <div class="dropdown-divider"></div>
                            @endforeach
                            </div>
                        </li>
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown">
                            <a class="nav-link" href="{{URL::to('admin/message')}}" title="Message"> <i class="font-24 mdi mdi-comment-processing"></i>
                                <sup style="top: -1.5em!important;">{{count($messagecount)}}</sup>    
                            </a>
                        </li>
                        <!-- ============================================================== -->
                        <!-- End Messages -->
