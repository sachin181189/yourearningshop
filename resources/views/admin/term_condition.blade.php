...
@include('admin/sidebar')
    @foreach($term_condition as $value)
        @php 
            $id = $value->id;
        ...
        <div class="page-wrapper">
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Term & Condition Info</h4>
            ...
            @endif
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action="{{ route('update-term-condition') }}" method="post" enctype="multipart/form-data">
                            @csrf
                                <div class="card-body">
