...
<div class="page-wrapper">
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Order Payment List</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        <form method="get" action="{{ route('payment-list') }}">
                            <div class="row">
                                <div class="col-3">
                                ...
                                <a class="btn btn-danger" href="{{ url('admin/payment-list') }}">Reset</a>
                                </div>
                            </div>
                        </form>
                    </div>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        @foreach($order as $value)
                                            <tr>
                                                ...
                                                <td><a title="View Order" href="{{ url('admin/view-order') }}/{{ $value->order_id }}"><i class="fa fa-eye"></i></a></td>
                                            </tr>
                                        @php
                                        $i++;
                                        @endphp
