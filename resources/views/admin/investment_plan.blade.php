...
@include('admin/sidebar')
    @foreach($investment_plan as $value)
        @php 
            $id = $value->id;
        ...
        <div class="page-wrapper">
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Update Investment plan </li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            @endif
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action="{{ route('update-investment-plan') }}" method="post" enctype="multipart/form-data">
                            @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <a href="remove-plan-image/1/image1/{{$id}}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <a href="remove-plan-image/1/image2/{{$id}}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <a href="remove-plan-image/1/image3/{{$id}}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <a href="remove-plan-image/1/image4/{{$id}}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                            @endif
                                        </div>
                                    </div>
