            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Our Product Info</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add new our product</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            @endif
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            @if( $id != '')
                            <form class="form-horizontal" action="{{ route('update-our-product') }}" method="post" enctype="multipart/form-data">
                            @else
                            <form class="form-horizontal" action="save-our-product" method="post" enctype="multipart/form-data">
                            @endif
                            @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4" id="imageDiv">
                                            <img id="proimage" class="proimage" src="{{ URL::asset('/our_product')}}/{{$image}}" alt="your image" style="width: 200px;height: 200px;" />
                                        </div>
                                    </div>
