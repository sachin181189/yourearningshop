        ...
        <div class="page-wrapper">
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Update business plan </li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            @endif
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action="{{ route('update-business-plan') }}" method="post" enctype="multipart/form-data">
                            @csrf
                                <div class="card-body">
