                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        @foreach($bannerlist as $value)
                                            <tr>
                                                ...
                                                <td width="33%"><img src="{{ URL::asset('/banner_image' )}}/{{ $value->banner_image }}" style="height:70px;width:243px;"></td>
                                                @if ($value->status == 1)
                                                ...
                                                @endif
                                                <td>
                                                <a title="Edit" href="edit-banner/{{ $value->id }}"><i class="fa fa-edit"></i></a>
                                                </td>
                                            </tr>
                                        @php
                                        $i++;
