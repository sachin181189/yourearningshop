...
<div class="page-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                    <a class="btn btn-success text-white" href="add-new-slider">Add new slider</a>
                </div>
            </div>
            </div>
            </div>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        @foreach($sliderlist as $value)
                                            <tr>
                                                <td>{{ $i }}</td>
                                                <td>{{ $value->title }}</td>
                                                <td width="33%"><img src="{{ URL::asset('/slider_image' )}}/{{ $value->slider_image }}" style="height:70px;width:243px;"></td>
                                                @if ($value->status == 1)
                                                ...
                                                @endif
                                                <td>
                                                <a title="Edit Slider" href="edit-slider/{{ $value->id }}"><i class="fa fa-edit"></i></a>
                                                <a href="#" title="Remove Slider" onclick="confirmremove('{{ $value->id }}');"><i class="fa fa-times"></i></a>
                                                </td>
                                            </tr>
                                        @php
                                        $i++;
