...
<div class="page-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                    <a class="btn btn-success text-white" href="add-new-brand">Add new brand</a>
                </div>
            </div>
            </div>
            </div>
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        @foreach($brand_list as $value)
                                            <tr>
                                                ...
                                                @endif
                                                <td><a title="Edit Brand" href="{{URL::to('admin/edit-brand')}}/{{ $value->id }}"><i class="fa fa-edit"></i></a>
                                                <a href="add-brand-gallery/{{ $value->id }}"><i class="fa fa-image"></i></a>
                                                </td>
                                            </tr>
                                        @php
                                        $i++;
