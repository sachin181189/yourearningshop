        ...
        <div class="page-wrapper">
            ...
            @endif
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action="{{ route('update-banner') }}" method="post" enctype="multipart/form-data">
                            @csrf
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="title" class="col-sm-3 text-right control-label col-form-label">Title</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="title" name="title" placeholder="Title Here" value="{{ $title }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <option value="top" @if($position == "top") selected @endif>Top</option>
                                            <option value="center" @if($position == "center") selected @endif>Center</option>
                                            <option value="bottom" @if($position == "bottom") selected @endif>Bottom</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <input type="hidden" value="{{$banner_image}}" name="hidden_image" class="form-control">
                                    <input type="hidden" value="{{$id}}" name="hidden_id" class="form-control">
                                    <div class="form-group row" id="imageDiv">
                                    <img id="proimage" class="proimage" src="{{ URL::asset('/banner_image')}}/{{$banner_image}}" alt="your image" style="width: 200px;height: 200px;" />
                                    </div>
                                </div>
