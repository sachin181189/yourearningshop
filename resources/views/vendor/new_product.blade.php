                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            @else
                            <form class="form-horizontal" action="vendor-save-product" method="post" enctype="multipart/form-data">
                            @endif
                            @csrf
                                <div class="card-body">
                                    <div class="row">
                                                        ...
                                                        <div class="optionBox1">
                                                            ...
                                                            <!--DEFAULT VARIANT START-->
                                                                <div class="block1">
                                                                    ...
                                                                    @if(count($product_variant_label) == 2)
                                                                    <div class="col-sm-3">
                                                                        <input type="number" class="form-control" id="price" name="main_price[]" placeholder="Price" value="{{$price}}" required="">
                                                                    </div>
                                                                    <div class="col-sm-3">
                                                                        <input type="number" class="form-control" id="offer_price" name="main_offer_price[]" placeholder="Offer Price" value="{{$offer_price}}" required="">
                                                                    </div>
                                                                    @elseif(count($product_variant_label) == 1)
                                                                    <div class="col-sm-3">
                                                                        <input type="number" class="form-control" id="price" name="main_price[]" placeholder="Price" value="{{$price}}" required="">
                                                            ...
                                                            @foreach($product_variant as $pv)
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    @if(count($product_variant_label) == 2)
                                                                    <div class="col-sm-3">
                                                                        <input type="number" class="form-control" id="price" name="main_price[]" placeholder="Price" value="{{$pv->price}}" required="">
                                                                    </div>
                                                                    <div class="col-sm-3">
                                                                        <input type="number" class="form-control" id="offer_price" name="main_offer_price[]" placeholder="Offer Price" value="{{$pv->offer_price}}" required="">
                                                                    </div>
                                                                    @elseif(count($product_variant_label) == 1)
                                                                    <div class="col-sm-3">
                                                                        <input type="number" class="form-control" id="price" name="main_price[]" placeholder="Price" value="{{$pv->price}}" required="">
...
function variatyHtml(response)
{
    ...
    var attribute_name_html = ``;
                    ...
                    attribute_textbox_html += `<div class="col-sm-3">
                                                        <input type="number" class="form-control" id="price" name="main_price[]" placeholder="Price" value="" required>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <input type="number" class="form-control" id="offer_price" name="main_offer_price[]" placeholder="Offer Price" value="" required>
                                                    </div>`;
                    }
                    else{
                        attribute_textbox_html += `<div class="col-sm-4">
