        ...
        <div class="page-wrapper">
            ...
            <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                            <a href="{{URL::to('vendor/product-list')}}" class="btn btn-success">Back to product list</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            @if( Request::segment(4))
                            <form class="form-horizontal" action="{{ route('update-vendor-product-image') }}" method="post" enctype="multipart/form-data">
                            @else
                            <form class="form-horizontal" action="{{ route('save-vendor-product-image') }}" method="post" enctype="multipart/form-data">
                            @endif
                            @csrf
                                <div class="card-body">
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        @foreach($product_image as $imagess)
                                            <tr>
                                                ...
                                                <td><a title="Edit Images" href="{{ url('vendor/edit-product-gallery') }}/{{ $imagess->product_id }}/{{ $imagess->id }}"><i class="fa fa-edit"></i></a></td>
                                            </tr>
                                        @php
                                        $i++;
                                        @endphp
