    ...
    <div class="row">
        ...
        <div class="col-sm-10" id="content">
            ...
            <div class="d-none" id="register_form">
                <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo e(route('save-users')); ?>" autocomplete="off">
                <?php echo csrf_field(); ?>
                    <fieldset id="account">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="text" class="form-control" id="input_referral" placeholder="Referred By" value="<?php echo e(base64_decode($_GET['r'])); ?>" name="referred_by" onblur="checkReferralCode(this.value)">
                                        <?php else: ?>
...
<?php /**PATH /home/nngogxwm/yourearningshop.com/resources/views/register.blade.php ENDPATH**/ ?>