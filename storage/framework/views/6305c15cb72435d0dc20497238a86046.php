        ...
        <div class="col-xl-2 col-lg-3">
          <div class="sidebar">
            ...
            <ul class="list-none mt-25">
                <?php $__currentLoopData = $undersubcategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
                  <input type="checkbox" id="<?php echo e($usc->undersubcategory); ?>" onclick="filterbyundersubcategory(<?php echo e($usc->id); ?>);" />
                  <label for="acer"><?php echo e($usc->undersubcategory); ?></label>
                </li>
            ...
            <div class="list-filter mt-43">
              ...
              <ul class="list-none mt-25">
                ...
                <li>
                  <input type="checkbox" id="<?php echo e($b->brand_name); ?>" onclick="filterbybrand(<?php echo e($b->id); ?>);" />
                  <label for="acer"><?php echo e($b->brand_name); ?></label>
                </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </ul>
            </div>
          ...
          <div class="tab-content">
            <div id="grid-products" class="tab-pane active">
              <div class="row" id="product_list1">
                ...
                <!--      <a href="#"><img src="<?php echo e(URL::asset('assets/images/products/shop/1.jpg')); ?>" alt="" /></a>-->
            ...
            <!--<div id="list-products" class="tab-pane">-->
              ...
              <!--      <div class="product-thumb">-->
              <!--        <a href="#"><img src="<?php echo e(URL::asset('assets/images/products/shop/16.jpg')); ?>" alt="" /></a>-->
              <!--        <div class="product-quick-view">-->
              <!--          <a href="javascript:void(0);" data-toggle="modal" data-target="#quick-view">quick view</a>-->
              <!--        </div>-->
              <!--      </div>-->
      ...
      $.ajax({
             ...
             data: {
                "_token": "<?php echo e(csrf_token()); ?>",
                 "cate_slug":'<?php echo e(Request::segment(2)); ?>',
                 "subcat_slug":'<?php echo e(Request::segment(3)); ?>',
      ...
      if(productdata.length > 0)
      {
        ...
        { 
          ...
          producthtml1 += `<div class="col-xl-3 col-md-4 col-sm-6" style="margin-bottom: 4em;">
                            <div class="product-single">
                              <div class="product-title">
                                <small><a href="<?php echo e(URL::to('product-detail')); ?>/`+val.slug+`">`+val.cat_slug+`</a></small>
          ...
          producthtml2 += `<div class="product-single wide-style">
                            <div class="row align-items-center">
                              ...
                              <div class="col-xl-6 col-lg-8 col-md-8 product-desc mt-md-50 sm-mt-50">
                                <a href="<?php echo e(URL::to('product-detail')); ?>/`+val.slug+`" class="add-to-wishlist"><i class="icon_heart_alt"></i></a>
                                <div class="product-title">
                                  <small><a href="<?php echo e(URL::to('product-detail')); ?>/`+val.slug+`">Samsung</a></small>
                                  <h4><a href="<?php echo e(URL::to('product-detail')); ?>/`+val.slug+`">`+val.product_name+`</a></h4>
                                </div>
                              ...
                              <div class="col-xl-3 col-lg-4 col-md-4">
                                <div class="product-action stuck text-left">
                                  <div class="free-delivery">
                                    <a href="<?php echo e(URL::to('product-detail')); ?>/`+val.slug+`"><i class="ti-truck"></i> Free Delivery</a>
                                  </div>
                                  <div class="product-price-rating">`;
                                  if(val.price != val.offer_price){
                                    producthtml2 += `<div>
                                ...
                                producthtml2 += `<span>₹`+parseInt(val.offer_price).toFixed(2)+`</span>
                                  ...
                                  <a href="<?php echo e(URL::to('product-detail')); ?>/`+val.slug+`" class="add-to-cart">Add to Cart</a>
                                </div>
                              </div>
                            </div>
                          </div>`;
...
</script><?php /**PATH /home/nngogxwm/yourearningshop.com/resources/views/product_list.blade.php ENDPATH**/ ?>