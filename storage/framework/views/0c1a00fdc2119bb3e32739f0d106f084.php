    ...
    <script src="<?php echo e(URL::asset('admin/assets/extra-libs/sparkline/sparkline.js')); ?>"></script>
    <!--Wave Effects -->
    <script src="<?php echo e(URL::asset('admin/dist/js/waves.js')); ?>"></script>
    <!--Menu sidebar -->
    ...
    <!-- this page js -->
    <script src="<?php echo e(URL::asset('admin/assets/extra-libs/multicheck/datatable-checkbox-init.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('admin/assets/extra-libs/multicheck/jquery.multicheck.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('admin/assets/extra-libs/DataTables/datatables.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('assets/editors/editor.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('admin/assets/libs/select2/dist/js/select2.full.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('admin/assets/libs/select2/dist/js/select2.min.js')); ?>"></script>
...
</script><?php /**PATH /home/nngogxwm/yourearningshop.com/resources/views/admin/footer.blade.php ENDPATH**/ ?>